/**
 * Constantes essenciais para o protocolo WhatsApp Web
 * Baseado no Baileys e whatsmeow
 */

// Versões do protocolo - Atualizado com base no Baileys
export const WA_VERSION = [2, 3000, 1023223821] as const;
export const WA_DEFAULT_EPHEMERAL = 7 * 24 * 60 * 60; // 7 dias em segundos
...
// Configurações de conexão - Atualizado com base no Baileys
export const CONNECTION_CONFIG = {
  ...
  sequentialInitDelay: 2000,
  batchSize: 50,
  batchDelay: 1000
} as const;

// Configurações do Noise Protocol - Atualizado com base no Baileys
export const NOISE_CONFIG = {
  mode: 'Noise_XX_25519_AESGCM_SHA256\0\0\0\0',
  pattern: 'Noise_XX_25519_AESGCM_SHA256',
  header: Buffer.from([87, 65, 6, 3]), // WA + magic(6) + dict_version(3)
  waHeader: Buffer.from([87, 65, 6, 3]),
  startPattern: 'Noise_XX_25519_AESGCM_SHA256',
  maxMessageSize: 2 << 23, // 16MB
  dictVersion: 3,
  magicValue: 6
} as const;
...
// Tags WABinary - Atualizado com base no Baileys
export const TAGS = {
  LIST_EMPTY: 0,
  STREAM_END: 2,
  DICTIONARY_0: 236,
...
export const WA_BINARY_TAGS = TAGS;

// Tokens de byte único WABinary - Baseado no testbaileys funcional
...
// Estrutura bidimensional do DOUBLE_BYTE_TOKENS baseada no Baileys funcional
...
// Manter compatibilidade com nome antigo
export const WA_BINARY_TOKENS = SINGLE_BYTE_TOKENS;
...
// Timeouts e intervalos - Atualizado com base no Baileys
export const TIMEOUTS = {
  ...
  QUERY_TIMEOUT: 60000,
  MESSAGE_SEND: 30000,
  PRESENCE_UPDATE: 10000,
  MIN_UPLOAD_INTERVAL: 5000
} as const;
...
export const DISCONNECT_REASON = {
  ...
  MULTIDEVICE_MISMATCH: 'multideviceMismatch'
} as const;
...
// Constantes do WebSocket Client
...
// Constantes do Curve25519
export const CURVE25519_CONSTANTS = {
   CURVE25519_SIZE: 32,
  ED25519_SIGNATURE_SIZE: 64,
  ED25519_PUBLIC_KEY_SIZE: 32,
  ED25519_PRIVATE_KEY_SIZE: 32,
  KEY_BUNDLE_TYPE: Buffer.from([0x05])
} as const;

// Constantes do Protocol Decoder
export const PROTOCOL_DECODER_CONFIG = {
  FRAME_HEADER_SIZE: 3,
  MAX_FRAME_SIZE: 2 * 1024 * 1024,
  WA_HEADER: Buffer.from([0x57, 0x41, 0x06, 0x03]) // WA 06 03
} as const;
...
export const HANDSHAKE_CONFIG = {
  NOISE_START_PATTERN: NOISE_CONFIG.pattern,
  NOISE_MODE: NOISE_CONFIG.mode,
  NOISE_HEADER: NOISE_CONFIG.waHeader,
  WA_CONN_HEADER: NOISE_CONFIG.waHeader
} as const;
